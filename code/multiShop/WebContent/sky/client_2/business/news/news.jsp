  		...
  		<div class="news-right">
  			<div class="news-content">
				...
				<nodata-panel data-ng-show="!isLoadingNews && newsList.length==0" font-size="22"></nodata-panel>
  				...
  				<div class="news-list" data-ng-show="!isLoadingNews" data-ng-repeat="item in newsList" data-ng-click="$root.selectedItem(item)">
  					<div class="news-list-pic" style="background-image: url({{item.picPathList[0] | getImgUrl}});"></div>
  					<div class="news-list-content">
  						<div>
  							<h1 title="{{item.name | showBlankValue}}">
  						...
  						<div><a class="news-linked" href="javascript:void(0)">查看全文</a></div>
  					</div>
  				</div>
  			</div>
